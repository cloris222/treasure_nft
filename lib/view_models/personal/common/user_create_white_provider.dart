...
final userCreateWhiteProvider =
    StateNotifierProvider.autoDispose<UserCreateWhiteNotifier, bool>((ref) {
  return UserCreateWhiteNotifier();
});

class UserCreateWhiteNotifier extends StateNotifier<bool>
