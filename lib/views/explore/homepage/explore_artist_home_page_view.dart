...
class _ExploreArtistHomePageView extends State<ExploreArtistHomePageView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar.mainNewAppBar(
          ...
          child: Column(
            children: [
              ...
              Stack(
                children: [
                  /// 黑色底
                  Container(color: AppColors.textBlack, width: double.infinity, height: UIDefine.getScreenWidth(10)),

                  Container(
                      padding: EdgeInsets.only(top: UIDefine.getScreenWidth(4.5)),
