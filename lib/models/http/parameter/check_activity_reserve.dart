...
ActivityReserveInfo activityReserveInfoFromJson(String str) => ActivityReserveInfo.fromJson(json.decode(str));

String activityReserveInfoToJson(ActivityReserveInfo data) => json.encode(data.toJson());
...
class ActivityReserveInfo {
  ...
  factory ActivityReserveInfo.fromJson(Map<String, dynamic> json) => ActivityReserveInfo(
